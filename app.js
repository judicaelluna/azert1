// Données du jeu
        ...
        const listPhrases = ["système informatique", "je sais coder", "faire la mise à jour", "apprendre chaque jour", "taper rapidement"];
        ...
        function changerMode() {
            if (motsRadio.checked) {
                listeActuelle = listMots;
                afficherMessage("Mode Mots activé", "#667eea");
            } else {
                listeActuelle = listPhrases;
